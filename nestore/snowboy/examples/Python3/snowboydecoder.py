...
from nestore_microphone import nestoreconv
import time
import wave
import os
import logging
...
"""def play_audio_file(fname=DETECT_DING):
    ...
    stream_out = audio.open(
        ...
        rate=int(44100), input=False, output=True)
...
class HotwordDetector(object):
    ...
    def play_audio_file(self):
        ...
        self.start(detected_callback=self.play_audio_file,interrupt_check=interrupt_callback,
              sleep_time=0.03)
        #self.start(detected_callback=self.play_audio_file,interrupt_check=interrupt_callback, 
         #     sleep_time=0.03) 
        self.terminate()
